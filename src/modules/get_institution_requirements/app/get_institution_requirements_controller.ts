...
export class GetInstitutionRequirementsController {
    public usecase: GetInstitutionRequirementsUsecase;
    ...
    public async execute(request: HttpRequest): Promise<HttpResponse> {
        try {
            ...
            return new OK(response, "Institution requirements found successfully");
        } catch (error: any) {
