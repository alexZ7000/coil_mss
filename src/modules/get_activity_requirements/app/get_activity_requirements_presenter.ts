...
const repository = new Repository({ user_repo: true, language_repo: true, course_repo: true, criteria_repo: true });

const usecase = new GetActivityRequirementsUsecase(repository.UserRepo, repository.CourseRepo, repository.CriteriaRepo, repository.LanguageRepo);
