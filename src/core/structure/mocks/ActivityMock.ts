  ...
  constructor() {
    this.activities = [
      new Activity({
        ...
        criterias: [
          this.criteria_mock.criterias[0],
          this.criteria_mock.criterias[1],
          this.criteria_mock.criterias[2],
        ],
        courses: [
          this.course_mock.courses[0],
          this.course_mock.courses[1],
          this.course_mock.courses[2],
        ],
      ...
      new Activity({
        ...
        criterias: [
          this.criteria_mock.criterias[3],
          this.criteria_mock.criterias[4],
          this.criteria_mock.criterias[5],
          this.criteria_mock.criterias[0],
        ],
        ...
        courses: [
          this.course_mock.courses[3],
          this.course_mock.courses[4],
          this.course_mock.courses[0],
        ],
      }),
      new Activity({
      ...
      new Activity({
        ...
        criterias: [
          ...
          this.criteria_mock.criterias[4],
          this.criteria_mock.criterias[5],
          this.criteria_mock.criterias[6],
        ],
        courses: [
          this.course_mock.courses[0],
          this.course_mock.courses[1],
